...
class AddSectionTemplate extends Component{
    ...
    addSectionToMenu = (evt)=>{
        ...
        axios.post("http://54.147.235.117:3001/addSectionToMenu", data).then((response) => {
...
class MenuType extends Component{
    ...
    deleteSection(section_id){
        ...
        axios.post("http://54.147.235.117:3001/deleteSection", data).then((response) => {
            if (response.status >= 500) {
                throw new Error("Bad response from server");
            }
            return response.data;
...
export class OwnerMenu extends Component{
    ...
    componentDidMount(){
        ...
        var data = {owner_id};
        axios.post("http://54.147.235.117:3001/getAllMenuItems", data).then((response) => {
            if (response.status >= 500) {
                throw new Error("Bad response from server");
            }
            return response.data;
